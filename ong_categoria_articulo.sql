...
CREATE TABLE `categoria_articulo` (
  ...
  KEY `id_categoria_idx` (`codcat`),
  CONSTRAINT `id_categoria` FOREIGN KEY (`codcat`) REFERENCES `categoria_articulo` (`id_articulo`)
...
INSERT INTO `categoria_articulo` VALUES (1,1);
